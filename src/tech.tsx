...
export default function TechStackMarquee() {
  return (
    <section className="w-full overflow-hidden bg-transparent py-10">
          ...
          {[...techStacks, ...techStacks].map((tech, index) => (
            ...
            >
              <img
                ...
                alt={tech.name}
                title={tech.name}
                className="h-14 w-14 object-contain transition-all duration-300 hover:scale-125 hover:rotate-6"
              />
